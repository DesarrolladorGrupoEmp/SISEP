        ...
        <div class="panel panel-default proc-pan-def3">
          ...
          <div class="titulohead">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 text-right">
                   <button id="btn_album_grupo" type="button" class="btn btn-primary botonnewgrupo" data-toggle="modal"  data-grupo="<?php echo $pkID_biotecnologia ?>" data-target="#frm_modal_album_grupo" <?php if (($crea != 1) || ($ne >= 30)) {echo 'disabled="disabled"';}?> ><span class="glyphicon glyphicon-plus"></span>
                   Crear album</button>
            ...
            <div class="col-md-12">
              <div class="dataTable_wrapper">
                      <table class="display table table-striped table-bordered table-hover" id="tbl_grupo_album">
                          ...
                          <tbody>
                              <?php
$detalles_biotecnologiaInst->getTablaAlbumGrupo($pkID_biotecnologia);
?>
                          </tbody>
                      </table>
                  </div>
