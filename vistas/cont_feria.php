...
$proyectoMGen   = $FeriaInst->getProyectosMarcoId($pkID_proyectoM);
...
<div id="page-wrapper" style="margin: 0px;">
  ...
  <div class="row">
    <!-- Campo que contiene el valor del id del modulo para auditoria con el nombre del modulo-->
      ...
      <div class="col-lg-12">
          <h1 class="page-header titleprincipal"><img src="../img/botones/grupoonly.png">Feria de Ciencias - <?php echo $proyectoMGen[0]["nombre"] ?></h1>
      </div>
      <!-- /.col-lg-12 -->
    <div class="col-md-9">
          <ol class="breadcrumb migadepan">
            ...
            <li class="active migadepan">Feria de Ciencias - <?php echo $proyectoMGen[0]["nombre"] ?> </li>
          </ol>
    </div>
