...
$biotecnologiaInst = new biotecnologiaController();

$arrPermisos = $biotecnologiaInst->getPermisosModulo_Tipo($id_modulo, $_COOKIE[$NomCookiesApp . '_IDtipo']);
$crea        = $arrPermisos[0]['crear'];

$pkID_proyectoM = $_GET["id_proyectoM"];
$proyectoMGen   = $biotecnologiaInst->getProyectosMarcoId($pkID_proyectoM);

include "form_biotecnologia.php";
?>
  ...
  <div class="row">
    ...
    <div class="col-md-9">
          <ol class="breadcrumb migadepan">
            ...
            <li class="active migadepan">Biotecnología- <?php echo $proyectoMGen[0]["nombre"] ?> </li>
          </ol>
    </div>

    <div class="col-md-2 text-center form-inline">
                    <label for="grupo_filtrop" class="control-label">Año: </label>
                      <?php $biotecnologiaInst->getSelectAnioFiltro();?>
     </div>
      ...
      <div class="col-lg-12">
        ...
        <div class="panel panel-default">
          ...
          <div class="titulohead">
            ...
            <div class="row">
              <div class="col-md-6">
                  <div class="titleprincipal"><h4>Registro de Biotecnología- <?php echo $proyectoMGen[0]["nombre"] ?></h4></div>
              </div>
              <div class="col-md-6 text-right">
                 <button id="btn_nuevobiotecnologia" type="button" class="btn btn-primary botonnewgrupo" data-toggle="modal" data-proyecto="<?php echo $pkID_proyectoM; ?>" data-target="#frm_modal_biotecnologia" <?php if ($crea != 1) {echo 'disabled="disabled"';}?> >
                 <span class="glyphicon glyphicon-plus"></span>Nuevo Biotecnología</button>
              </div>
            </div>
