            ...
            for ($a = 0; $a < sizeof($this->sesion); $a++) {
                ...
                echo '
                             <tr>
                                 ...
                                 <td>
                                     <button id="edita_sesion" title="Editar" name="edita_sesion" type="button" class="btn btn-warning" data-toggle="modal" data-target="#frm_modal_sesion" data-id-sesion = "' . $id . '" ';
