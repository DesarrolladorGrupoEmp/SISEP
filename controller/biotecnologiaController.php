...
include_once '../DAO/biotecnologiaDAO.php';
include_once 'helper_controller/render_table.php';

class biotecnologiaController extends biotecnologiaDAO
{
    ...
    public function getTablabiotecnologia($filtro, $pkID_proyectoM)
    {
        ...
        $array_opciones = [
            "modulo" => "biotecnologia", //nombre del modulo definido para jquerycontrollerV2
            "title"  => "Click Ver Detalles", //etiqueta html title
            "href"   => "detalles_biotecnologia.php?id_biotecnologia=",
            "class"  => "detail", //clase que permite que añadir el evento jquery click
        ];
        //---------------------------------------------------------------------------------
        //carga el array desde el DAO
        if ($filtro == "'Todos'") {
            $grupo = $this->getbiotecnologias($pkID_proyectoM);
        } else {
            $grupo = $this->getbiotecnologia($filtro, $pkID_proyectoM);
        }
    ...
    public function getGeneral($pkID)
    {
        ...
        echo '<div class="col-sm-6">
            ...
            <div class="col-sm-6">
              ...
              <strong>Documento Técnico: </strong> <a href="../server/php/files/' . $this->gruposId[0]["url_documento"] . '" target="_blank">' . $this->gruposId[0]["url_documento"] . ' <img src="../img/pdfdescargable.png" width="20px"></a><br> <br>
              <strong>Informe: </strong> <a href="../server/php/files/' . $this->gruposId[0]["url_informe"] . '" target="_blank">' . $this->gruposId[0]["url_informe"] . ' <img src="../img/pdfdescargable.png" width="20px"></a> <br> <br>
              ';
    ...
    public function getTablabiotecnologiaEstudiantes($pkid_biotecnologia)
    {
        ...
        $grupo_btn = [
            [
                "tipo"    => "eliminar",
                "nombre"  => "biotecnologia_estudiante",
                "permiso" => $elimina,
            ],
        ...
        //---------------------------------------------------------------------------------
        //carga el array desde el DAO
        $grupo = $this->getbiotecnologiaEstudiantes($pkid_biotecnologia);
        //print_r($grupo);
    ...
    public function getTablasesiones($pkID_biotecnologia)
    {

        //$sesion = $this->getsesiones(pkID_biotecnologia);
        $this->sesion = $this->getSesiones($pkID_biotecnologia);
            ...
            for ($a = 0; $a < sizeof($this->sesion); $a++) {
                ...
                echo '
                             <tr>
                                 ...
                                 <td>
                                     <button id="edita_sesion" title="Editar" name="edita_sesion" type="button" class="btn btn-warning" data-toggle="modal" data-target="#frm_modal_biotecnologia_sesion" data-id-sesion = "' . $id . '" ';
